...
const Poster = () => {
  return (
    <div className="flex min-w-[250px] max-w-[650px] flex-1 flex-col items-center justify-center bg-dark-gray p-2 pb-10 shadow-poster sm:p-4 md:min-w-[650px] lil:min-w-[435px]">
